...
const Footer = () => {
    return(
        <div className="rodape">
            <div className="rodape-container">
                <div className="esquerda">
                    ...
                    <div>
                        ...
                        <h4 className="recife" style={{color: '#fff'}}>Av.recife - Recife</h4>
                    </div>
                    <div className="icones">
            ...
            <div className="float">
            <a href='https://api.whatsapp.com/send?1=pt_BR&phone=5581997721518&text=Eu%20gostaria%20de%20conhecer%20o%20produto.'><FaWhatsapp size={50} style={{color: '#fff'}}/></a>
            </div>
            </div>
        </div>
    )
